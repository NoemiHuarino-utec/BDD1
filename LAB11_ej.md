...
COPY lab11.actor10000 FROM 'C:\noe\10000\actor.tsv' DELIMITER E'\t';
...
COPY lab11.pelicula10000 FROM 'C:\noe\10000\movie.tsv' DELIMITER E'\t' NULL AS 'null';
...
COPY lab11.personaje10000 FROM 'C:\noe\10000\role.tsv' DELIMITER E'\t';
...
COPY lab11.actor1000 FROM 'C:\noe\1000\actor.tsv' DELIMITER E'\t';
...
COPY lab11.pelicula1000 FROM 'C:\noe\1000\movie.tsv' DELIMITER E'\t' NULL AS 'null';
...
COPY lab11.personaje1000 FROM 'C:\noe\1000\role.tsv' DELIMITER E'\t';
...
COPY lab11.actor100 FROM 'C:\noe\100\actor.tsv' DELIMITER E'\t';
...
COPY lab11.pelicula100 FROM 'C:\noe\100\movie.tsv' DELIMITER E'\t' NULL AS 'null';
...
COPY lab11.personaje100 FROM 'C:\noe\100\role.tsv' DELIMITER E'\t';
...
COPY lab11i.pelicula10000 FROM 'C:\noe\10000\movie.tsv' DELIMITER E'\t' NULL AS 'null';
...
COPY lab11i.personaje10000 FROM 'C:\noe\10000\role.tsv' DELIMITER E'\t';
...
COPY lab11i.pelicula1000 FROM 'C:\noe\1000\movie.tsv' DELIMITER E'\t' NULL AS 'null';
...
COPY lab11i.personaje1000 FROM 'C:\noe\1000\role.tsv' DELIMITER E'\t';
...
COPY lab11i.pelicula100 FROM 'C:\noe\100\movie.tsv' DELIMITER E'\t' NULL AS 'null';
...
COPY lab11i.personaje100 FROM 'C:\noe\100\role.tsv' DELIMITER E'\t';
